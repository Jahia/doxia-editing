...
/**
 * A fork of the Doxia Default Converter class to add support for the MARKDOWN format.
 * Created by loom on 21.07.14.
 */
public class ExtendedDefaultConverter
    implements Converter
{
    ...
    public static final String[] SUPPORTED_FROM_FORMAT =
        { APT_PARSER, CONFLUENCE_PARSER, DOCBOOK_PARSER, FML_PARSER, TWIKI_PARSER, XDOC_PARSER, XHTML_PARSER, MARKDOWN_PARSER };
     ...
     * @see {@link org.codehaus.plexus.util.xml.XmlStreamReader#getEncoding()} for xml files
     * @see {@link com.ibm.icu.text.CharsetDetector#detect()} for text files
     */
